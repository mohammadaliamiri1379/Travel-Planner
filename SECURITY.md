...
If you find a security vulnerability in Travel_planner, please report it through [GitHub's private vulnerability reporting](https://github.com/Mohammadali Amiri/travel_planner/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact mohammadali.amiri@mail.polimi.it for details.
